...
def convert_mcd_png(path_mcd,roi_exclude,marker_exclude):
...
def visualize_roi(cofactor=1000,thresh=2,kernel=5,path_raw="./images/raw_images"):
    path="./images/arcsinh_images"
    if os.path.isdir(path)==False:
        os.mkdir(path)
...
def classified_image_by_marker(path_img="./images/arcsinh_img"):
    if os.path.isdir("./images/marker_arcsinh")==False:
        os.mkdir("./images/marker_arcsinh")
    for roi in os.listdir("./images/arcsinh_images"):
        print("   ROI: "+roi)
        for marker in os.listdir("./images/arcsinh_images/"+roi):
            if os.path.isdir("./images/marker_arcsinh/"+marker[:-4])==False:
                os.mkdir("./images/marker_arcsinh/"+marker[:-4])
            cv2.imwrite("./images/marker_arcsinh/"+marker[:-4]+"/"+roi+".png",normalize_255((plt.imread("./images/arcsinh_images/"+roi+"/"+marker))))
